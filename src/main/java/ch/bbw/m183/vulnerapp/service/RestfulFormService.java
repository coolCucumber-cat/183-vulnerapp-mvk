 ...
 * For our RestFull endpoint we disable the redirect and enforce a direct JSON
 * response:
...
public class RestfulFormService {
	...
	/**
	 * Put it in your SecurityFilterChain like
	 * {@code .formLogin(restfulFormService.restfulFormLogin())}.
	 */
	...
	/**
	 * Put it in your SecurityFilterChain like
	 * {@code .exceptionHandling(restfulFormService.unauthorizedPerDefault())}.
	 */
